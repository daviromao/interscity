  ...
  describe '/resources' do
    ...
    describe '/data' do
      describe 'POST /' do
        before do
          connection.headers = { 'Content-Type' => 'application/json' }
          @response = connection.post('collector/resources/data')
        end
      ...
      describe '/last' do
        describe 'POST /' do
          before do
            connection.headers = { 'Content-Type' => 'application/json' }
            @response = connection.post('collector/resources/data/last')
          end
    ...
    describe '/{uuid}' do
      describe '/data' do
        describe 'POST /' do
          before do
            @response = connection.post("collector/resources/#{@uuid}/data")
          end
